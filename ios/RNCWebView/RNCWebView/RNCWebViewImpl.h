...
typedef enum RNCWebViewImplPermissionGrantType : NSUInteger {
  RNCWebViewImplPermissionGrantType_GrantIfSameHost_ElsePrompt,
  RNCWebViewImplPermissionGrantType_GrantIfSameHost_ElseDeny,
  RNCWebViewImplPermissionGrantType_Deny,
  RNCWebViewImplPermissionGrantType_Grant,
  RNCWebViewImplPermissionGrantType_Prompt
} RNCWebViewImplPermissionGrantType;

@class RNCWebViewImpl;

@protocol RNCWebViewImplDelegate <NSObject>
...
@property (nonatomic, weak) id<RNCWebViewImplDelegate> _Nullable delegate;
...
@property (nonatomic, assign) RNCWebViewImplPermissionGrantType mediaCapturePermissionGrantType;
#endif
